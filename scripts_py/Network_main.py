...
`scripts_py/network/`. It is intentionally thin: command-line parsing,
...
Subcommands:
    train
        ...
        `outputs/networks_results/<model_name>/train_outputs/<dataset>_last_*.pt` checkpoint when
    ...
    predict
        ...
        `outputs/networks_results/<model_name>/train_outputs/<dataset>_best.pt`; if that
...
Output naming:
    ...
    Prediction files use the same suffix rule:
        outputs/networks_results/<model_name>/test_outputs/<dataset>_predictions_MMDD_HHMMSS.csv
        outputs/networks_results/<model_name>/test_outputs/<dataset>_range_prediction_MMDD_HHMMSS.png
