"""HDF5 dataset utilities for MATLAB-exported SCM pair-vector features."""
...
def random_split_bundle(
    ...
    *,
    ...
    dataset = ScmRangeH5Dataset(source_paths, normalize_input=normalize_input)
...
def fixed_split_bundle(
    ...
    *,
    ...
    train_dataset = ScmRangeH5Dataset(train_paths, normalize_input=normalize_input)
    val_dataset = ScmRangeH5Dataset(val_paths, normalize_input=normalize_input)
...
class ScmRangeH5Dataset(Dataset):
    """Lazy HDF5 dataset for SCM upper-triangle covariance features."""
