"""Prediction and plotting utilities for SCM models."""
...
from .data import ScmRangeH5Dataset, resolve_h5_paths
...
def predict(args: argparse.Namespace) -> None:
    ...
    if not args.no_plot:
        ...
        save_prediction_plot(rows, plot_path, title="SCM Source Range Prediction")
