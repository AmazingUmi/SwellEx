"""Complex-valued CNN model for flattened ELM pairwise-ratio inputs."""
...
class ElmComplexRangeCNN(nn.Module):
    """Complex CNN regressor for flattened ELM pairwise-ratio features."""
