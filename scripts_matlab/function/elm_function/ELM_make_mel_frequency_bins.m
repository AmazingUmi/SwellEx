function [freq_bin_idx, selected_freq_hz, mel_center_freq_hz] = ...
    ELM_make_mel_frequency_bins(full_freq_hz, num_mel_bins, min_freq_hz, max_freq_hz)
%ELM_MAKE_MEL_FREQUENCY_BINS Select FFT bins nearest to Mel-spaced centers.
%
% This is a simple complex-spectrum filter: it does not apply triangular
% Mel weights. Instead, it keeps the FFT bins closest to Mel-spaced center
% frequencies so the downstream feature remains complex-valued.
